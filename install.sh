...
echo ""
echo "  Create a new application in your GitLab instance:"
echo "  1. Go to any group > Settings > Applications"
echo "  2. Create an application with:"
echo -e "     - Name: ${BOLD}Plumber self-managed${NC}"
...
prompt GITLAB_OAUTH2_CLIENT_SECRET "Secret"
